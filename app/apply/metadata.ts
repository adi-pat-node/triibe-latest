...
export const metadata: Metadata = {
  title: "Apply - Join TRIIBE's Programs",
  description:
    "Apply to join TRIIBE's mentorship program and connect with experienced leaders to advance your social impact initiatives. Open to young changemakers worldwide.",
  openGraph: {
