...
export const metadata = {
  title: "Thank You - Host an Event",
  description: "Thank you for hosting an event",
  alternates: {
    canonical: "https://www.triibe.org/thank-you-host",
  },
};

export default function ThankYouHost() {
  return (
      ...
      <section className="flex-grow flex items-center justify-center px-4 py-32">
        <div className="max-w-2xl w-full text-center">
          ...
          <p className="text-lg text-[#495565] leading-relaxed mb-12 max-w-xl mx-auto">
            Thank you for your interest in hosting an event! We have received
            your details and our team will be in touch with you shortly.
          </p>
