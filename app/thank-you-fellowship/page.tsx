...
export const metadata = {
  title: "Thank You - TRIIBE Fellowship",
  description: "Thank you page",
  alternates: {
    canonical: "https://www.triibe.org/thank-you-fellowship",
  },
};

export default function ThankYouFellowship() {
  return (
      ...
      <section className="flex-grow flex items-center justify-center px-4 py-32">
        <div className="max-w-2xl w-full text-center">
          ...
          <p className="text-lg text-[#495565] leading-relaxed mb-12 max-w-xl mx-auto">
            Thank you for applying to the TRIIBE Fellowship! Our team will
            review your profile and video submission shortly.
          </p>
