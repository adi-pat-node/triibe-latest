...
export default function ApplicationProcess() {
  return (
    <section
      className="flex flex-col items-start gap-12 px-4 md:px-25 lg:px-50 py-20 w-full bg-gray-50"
      id="applyfellowship"
    >
            ...
            <div className="flex flex-col gap-8 pt-8 border-t border-gray-200">
              ...
              <div className="flex flex-col gap-4 w-full">
                ...
                <a
                  ...
                  className="px-6 py-3 bg-[#002c19] text-white hover:bg-[#1C5945] border border-black rounded-sm h-[44px]  transition-colors font-semibold text-base w-full md:w-auto text-center cursor-pointer"
                >
                  Donate
                </a>
              </div>
